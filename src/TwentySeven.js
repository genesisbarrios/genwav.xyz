...
const Twentyseven = (props) => {
  ...
  return(
    <div id="NEW">
      <div class="wrapper">
          <MetaTags>
            <title>27 | gen.wav</title>
            <meta id="meta-description" name="description" content="27 - gen.wav" />
            <meta id="og-title" property="og:title" content="27 - gen.wav" />
            <meta id="og-image" property="og:image" content="https://genwav.xyz/27art.png" />
          </MetaTags>
        </div>
        ...
        <Grid item xs={12} sm={12}>
         ...
         <Grid container spacing={2} className="logo-button-container">
          ...
          <Grid container spacing={2} className="logo-button-container">
            ...
            <Grid item xs={6} sm={6}>
              <a target="_blank" href="https://genwav.bandcamp.com/track/27"><button className="pre-save-button">Buy</button></a>
            </Grid>
          </Grid>
           <Grid container spacing={2} className="logo-button-container">
            <Grid item xs={6} sm={6} style={{display:"flex", alignItems: "center"}}>
