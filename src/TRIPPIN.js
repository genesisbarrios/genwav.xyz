...
//   title: 'TRIPPIN',
//   description: 'Trippin' - SRI (feat. gen.wav)',
//   openGraph: {
//     title: 'Trippin' - SRI (feat. gen.wav)',
//     description: 'Trippin' - SRI (feat. gen.wav)',
...
const TRIPPIN = (props) => {
  ...
  useEffect(() => {
    // Track when TRIPPIN page is viewed
    trackReleasePageView('TRIPPIN');
  }, []);
  ...
  return(
    <div id="NEW">
      <div class="wrapper">
          <MetaTags>
            <title>Trippin' | SRI, gen.wav</title>
            <meta id="meta-description" name="description" content="Trippin' - SRI (feat. gen.wav)" />
            <meta id="og-title" property="og:title" content="Trippin' - SRI (feat. gen.wav)" />
            <meta id="og-image" property="og:image" content="https://genwav.xyz/TRIPPIN.JPG" />
          </MetaTags>
        </div>
