          ...
          <div style={{ display: "inline" }}>
            ...
            <Card style={{marginBottom:"2%"}}>
              <CardActionArea href="https://genwav.xyz/WORLD">
                <CardMedia
                  component="img"
                  alt="The World is a Stage Artwork"
                  height="250"
                  image="https://genwav.xyz/WORLD/WORLD8.JPG"
                  title="WORLD IS A STAGE"
                />
                <CardContent style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", color: "white", backgroundColor: "rgba(0, 0, 0, 0.5)" }}>
                  <Typography variant="h6" component="h6">
            ...
            <Card style={{marginBottom:"2%"}}>
              <CardActionArea href="https://genwav.xyz/MATRIX">
                <CardMedia
                  component="img"
                  alt="THE MATRIX Artwork"
                  height="250"
                  image="https://genwav.xyz/RENACI.png"
                  title="MATRIX"
                />
                <CardContent style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", color: "white", backgroundColor: "rgba(0, 0, 0, 0.5)" }}>
                  <Typography variant="h6" component="h6">
             ...
             <Card style={{marginBottom:"2%"}}>
              <CardActionArea href="https://genwav.xyz/UP">
                <CardMedia
                  component="img"
                  alt="UP Artwork"
                  height="250"
                  image="https://genwav.xyz/UPCoverArt.png"
                  title="UP"
                />
                <CardContent style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", color: "white", backgroundColor: "rgba(0, 0, 0, 0.5)" }}>
                  <Typography variant="h6" component="h6">
            ...
            <Card style={{marginBottom:"2%"}}>
              <CardActionArea href="https://genwav.xyz/TURO">
                <CardMedia
                  component="img"
                  alt="TURO Artwork"
                  height="250"
                  image="https://genwav.xyz/TuroArt.png"
                  title="TURO"
                />
                <CardContent style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", color: "white", backgroundColor: "rgba(0, 0, 0, 0.5)" }}>
                  <Typography variant="h6" component="h6">
              ...
              <Card style={{marginBottom:"2%"}}>
              <CardActionArea href="https://genwav.xyz/22">
                <CardMedia
                  component="img"
                  alt="22 Artwork"
                  height="250"
                  image="https://genwav.xyz/22art.png"
                  title="22"
                />
                <CardContent style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", color: "white", backgroundColor: "rgba(0, 0, 0, 0.5)" }}>
                  <Typography variant="h6" component="h6">
